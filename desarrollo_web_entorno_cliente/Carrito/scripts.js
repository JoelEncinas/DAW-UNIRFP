...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const cargarProductos = (productos) => {
    ...
    // alojada en https://jsonbin.io/ en vez de jsonblob ya que daba error al guardar
    // he tenido que modificarlo para que encaje con la nueva API ya que añade un campo "record"
  ...
  const actualizarTotal = function () {
    ...
    carrito.products.forEach((pro) => {
      ...
      precioCantidad.textContent = " x  " + pro.price + currency;
  ...
  const cargarTabla = (misProductos) => {
    ...
    misProductos.forEach((product) => {
      ...
      masButton.classList.add("btn-retro");
      ...
      menosButton.classList.add("btn-retro");
  ...
  // Esta api expira en 24h desde las 21:16 del 06/10/2025
  // en https://jsonbin.io/

  const api = "https://api.jsonbin.io/v3/qs/68e41557ae596e708f086ba2";
  fetch(api)
  ...
  // Datos utilizados para generar la api
  ...
  "products": [
    {
      "SKU": "X1A7B9C3D4",
      "title": "Pentium II CPU 300MHz",
      "price": "199.99"
    },
    {
      "SKU": "Z8Y6W5V4U3",
      "title": "64MB SDRAM Module",
      "price": "89.99"
    },
    {
      "SKU": "Q1W2E3R4T5",
      "title": "3.5\" Floppy Disk 10-Pack",
      "price": "12.99"
    },
    {
      "SKU": "M5N4B3V2C1",
      "title": "CRT Monitor 15\"",
      "price": "149.99"
    },
    {
      "SKU": "L9K8J7H6G5",
      "title": "Sound Blaster 16 Sound Card",
      "price": "79.99"
    },
    {
      "SKU": "P1O2I3U4Y5",
      "title": "Logitech Mouse Ball",
      "price": "24.99"
    },
    {
      "SKU": "A1S2D3F4G5",
    ...
    {
      "SKU": "V6B5N4M3C2",
      "title": "IDE Hard Drive 10GB",
      "price": "199.99"
    },
    {
      "SKU": "R4T5Y6U7I8",
      "title": "12X CD-ROM Drive",
      "price": "79.99"
    },
    {
      "SKU": "E9R8T7Y6U5",
      "title": "15\" VGA Monitor",
      "price": "139.99"
    },
    {
      "SKU": "F1G2H3J4K5",
      "title": "ISA Network Card 10Mbps",
      "price": "49.99"
    },
    {
      "SKU": "N2M3B4V5C6",
      "title": "Zip Drive 100MB",
      "price": "129.99"
    },
    {
      "SKU": "T1Y2U3I4O5",
      "title": "External 56k Modem",
      "price": "59.99"
    },
    {
      "SKU": "C1V2B3N4M5",
      "title": "Speakers 2.0 Stereo",
      "price": "34.99"
    },
    {
      "SKU": "H1J2K3L4P5",
      "title": "PC Game: Doom II",
      "price": "49.99"
    },
    {
      "SKU": "S9D8F7G6H5",
      "title": "Windows 98 OEM CD",
      "price": "99.99"
    },
    {
      "SKU": "Q7W8E9R0T1",
      "title": "Netscape Navigator 4.08 CD",
      "price": "19.99"
    },
    {
      "SKU": "M6N5B4V3C2",
      "title": "Joystick Gravis Gamepad",
      "price": "39.99"
    },
    {
      "SKU": "K3L2J1H0G9",
      "title": "VGA Video Card 4MB",
      "price": "129.99"
    },
    {
      "SKU": "X9Y8Z7A6B5",
      "title": "CRT Monitor 17\"",
      "price": "189.99"
    }
  ]
